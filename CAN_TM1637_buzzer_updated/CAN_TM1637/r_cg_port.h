...
#define _00_ADPC_DI_OFF             (0x00U) /* use P33, P34, P80 - P87 as analog input */
#define _0A_ADPC_DI_ON              (0x0AU) /* use P87 as digital input */
#define _09_ADPC_DI_ON              (0x09U) /* use P86 - P87 as digital input */
#define _08_ADPC_DI_ON              (0x08U) /* use P85 - P87 as digital input */
#define _07_ADPC_DI_ON              (0x07U) /* use P84 - P87 as digital input */
#define _06_ADPC_DI_ON              (0x06U) /* use P83 - P87 as digital input */
#define _05_ADPC_DI_ON              (0x05U) /* use P82 - P87 as digital input */
#define _04_ADPC_DI_ON              (0x04U) /* use P81 - P87 as digital input */
#define _03_ADPC_DI_ON              (0x03U) /* use P80 - P87 as digital input */
#define _02_ADPC_DI_ON              (0x02U) /* use P34, P80 - P87 as digital input */
#define _01_ADPC_DI_ON              (0x01U) /* use P33, P34, P80 - P87 as digital input */
