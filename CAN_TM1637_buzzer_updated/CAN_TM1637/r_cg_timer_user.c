...
int i=0;
extern uint8_t message_er1_l[4];  //EOL
extern uint8_t message_er2_c[4];   //EOC
extern uint8_t message_er3_f[4];  //EOF
extern uint8_t message_er4_0[4];   //EO
extern uint8_t message_er5_r[4];  //err
/* End user code. Do not edit comment generated here */
...
static void __near r_tau0_channel0_interrupt(void)
{
	...
	TM1637Display_message(message_er2_c);   
	BIP=0;
    }
    else{
