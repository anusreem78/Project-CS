...
/* Control of PWM output delay time of TAU1 TO14 */
#define _0000_TO14_OUTPUT_DELAY_0               (0x0000U) /* no delay */
#define _0100_TO14_OUTPUT_DELAY_1               (0x0100U) /* delay 1 cycle */
#define _0200_TO14_OUTPUT_DELAY_2               (0x0200U) /* delay 2 cycles */
#define _0300_TO14_OUTPUT_DELAY_3               (0x0300U) /* delay 3 cycles */
/* Control of PWM output delay time of TAU1 TO15 */
#define _0000_TO15_OUTPUT_DELAY_0               (0x0000U) /* no delay */
#define _0400_TO15_OUTPUT_DELAY_1               (0x0400U) /* delay 1 cycle */
#define _0800_TO15_OUTPUT_DELAY_2               (0x0800U) /* delay 2 cycles */
#define _0C00_TO15_OUTPUT_DELAY_3               (0x0C00U) /* delay 3 cycles */
/* Control of PWM output delay time of TAU1 TO16 */
#define _0000_TO16_OUTPUT_DELAY_0               (0x0000U) /* no delay */
#define _1000_TO16_OUTPUT_DELAY_1               (0x1000U) /* delay 1 cycle */
#define _2000_TO16_OUTPUT_DELAY_2               (0x2000U) /* delay 2 cycles */
#define _3000_TO16_OUTPUT_DELAY_3               (0x3000U) /* delay 3 cycles */
/* Control of PWM output delay time of TAU1 TO17 */
#define _0000_TO17_OUTPUT_DELAY_0               (0x0000U) /* no delay */
#define _4000_TO17_OUTPUT_DELAY_1               (0x4000U) /* delay 1 cycle */
#define _8000_TO17_OUTPUT_DELAY_2               (0x8000U) /* delay 2 cycles */
#define _C000_TO17_OUTPUT_DELAY_3               (0xC000U) /* delay 3 cycles */
...
#define _30D4_TAU_TDR01_VALUE                   (0x30D4U)
